...
class Renderer:
    ...
    def init_network(self, res,
        ...
        **kwargs
        ...
        # self.w_load = torch.load("/home/sarper/Desktop/GANs/DragGAN/e4e_latents/latents_756.pt")
    ...
    def _render_drag_impl(self, res,
        ...
        **kwargs
        ...
        # img = torch.ones((G.img_resolution, G.img_resolution, 3), dtype=torch.uint8) * 255
        # res.image = img
